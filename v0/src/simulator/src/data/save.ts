...
import {ProjectNameFunctions, DownloadFunction, SaveData,TabsOrderFunction, GenerateSaveDataFunction
, DependencyList, CompletedList, ImgType, ViewType, GenerateImageParams, CropParams, GenerateImageForOnlineReturn,
Resolution, Headers , ProjectData, SaveFunctionReturn }  from '../types/saveScope';
 ...
 * @category data
 */
export const setProjectName: ProjectNameFunctions["setProjectName"] = (name) => {
 ...
 * @category data
 */
export const getProjectName: ProjectNameFunctions["getProjectName"] = () => {
    const projectStore = useProjectStore();
 ...
 * @category data
 */
const downloadAsImg: DownloadFunction = (name, imgType) => {
 ...
 */
export const getTabsOrder: TabsOrderFunction = () => {
    const tabs = document.getElementById("tabsBar")?.firstChild?.children;
    if (!tabs) return [];
    return Array.from(tabs).map((tab) => tab.id);
  };
 ...
 * @category data
 */
export const generateSaveData: GenerateSaveDataFunction = async (name, setName = true) => {
...
const download: DownloadFunction = (filename: string, text: string): void => {
...
export function generateImage({
    ...
    resolution,
    down = true
}: GenerateImageParams): string | void {
    // Backup all data
...
async function crop({ dataURL, w, h }: CropParams): Promise<string> {
 ...
 * @exports save
 */
export default async function save(): SaveFunctionReturn {
