  ...
  <div style="height: 100%; width: 100%">
    <div id="simulation" class="simulation" style="height: 100%; width: 100%">
      ...
      <div id="zoom-in-out-embed" class="zoom-wrapper">
        <div class="noSelect">
          <button id="zoom-in-embed" type="button" style="font-size: 25px" @click="zoomInEmbed">
            <span class="fa fa-search-plus" aria-hidden="true" title="Zoom In" />
          </button>
        </div>
        <div class="noSelect">
          <button id="zoom-out-embed" type="button" style="font-size: 25px" @click="zoomOutEmbed">
            <span class="fa fa-search-minus" aria-hidden="true" title="Zoom Out" />
          </button>
        </div>
      </div>
      ...
      <div style="position: absolute; right: 10px; top: 25px; z-index: 100" class="clockPropertyHeader noSelect">
        <div id="clockProperty">
          <input type="button" class="objectPropertyAttributeEmbed custom-btn--secondary embed-fullscreen-btn"
            name="toggleFullScreen" value="Full Screen" @click="toggleFullScreen">
          <div>
            Time:
            <input v-model="timePeriod" class="objectPropertyAttributeEmbed embed-time-input" min="50" type="number"
              style="width: 48px" step="10" name="changeClockTime">
          </div>
          <div>
            Clock:
            <label class="switch">
              <input v-model="clockEnabled" type="checkbox" class="objectPropertyAttributeEmbedChecked"
      ...
      <div id="bottom_right_watermark">
        <a style="
                        ...
                        color: grey;
                        z-index: 2;
                    " href="https://circuitverse.org/" target="_blank">
