 ...
 *  A low level canvas to SVG converter.
 *  Uses a mock canvas context to build an SVG document.
 *
...
let STYLES; let ctx; let CanvasGradient; let CanvasPattern; let namedEntities;
...
function randomString(holder) {
  let chars; let randomstring; let i;
  if (!holder) {
    throw new Error(
