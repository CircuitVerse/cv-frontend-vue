...
const themes: Themes = {
  ...
  "Sunset Glow": {
    ...
    "--text-navbar--alt": "#333",
    "--br-secondary": "#ff9ff3",
    "--br-circuit-cur": "#feca57",
    "--cus-radio_label": "#ff6b6b",
    "--primary": "#feca57",
    "--text-lite": "#fff",
    "--text-dark": "#333",
    "--text-panel": "#333",
    "--qp-br-tl": "#ff9ff3",
    "--qp-br-rd": "#feca57",
    "--qp-box-shadow-1": "#ff6b6b",
    "--qp-box-shadow-2": "#ff9ff3",
    "--bg-circuit": "#fff8e1",
    "--br-circuit": "#ff6b6b",
    "--br-primary": "#feca57",
    "--bg-primary-moz": "#feca57e6",
    "--bg-primary-chr": "#feca57b3",
    "--bg-tabs": "#ff9ff3",
    "--bg-icons": "#ff6b6b",
    "--bg-text": "#feca57",
    "--bg-secondary": "#ff9ff3",
    "--canvas-stroke": "#ff6b6b",
    "--canvas-fill": "#fffacd",
    "--context-text": "#333",
    "--bg-toggle-btn-primary": "#ff6b6b",
    "--primary-btn-hov": "#ff9ff3",
    "--btn-danger": "#ff4d4d",
    "--btn-danger-darken": "#ff6b6b",
    "--disable": "#ccc",
    "--cus-btn-hov--bg": "#feca57",
    ...
    "--mini-map-stroke": "#333",
    "--input-text": "#ff6b6b",
    "--secondary-stroke": "#ff4d4d",
    "--text": "#333",
    "--wire-norm": "#333",
    "--node-norm": "#feca57",
    "--splitter": "#ff6b6b",
    "--output-rect": "#48dbfb",
    "--table-head-dark": "#ff6b6b",
  },
