...
// const GetDialogData = () =>
//     '<div><label for="CircuitDataFile">Choose file</label><div id="message-box"><i class="fas fa-plus"></i><br/>Browse files or Drag & Drop files here<div id="message">No file chosen!!</div><input style="background:none;" type="file" id="CircuitDataFile"/></div></div>'
...
//                         throw new Error('Invalid Scope data')
//                 })
//             })
//             load(parsedFileDate)
//             return true
...
//             generateSaveData(escapeHtml($('#projectName').text()).trim(), false)
//         )
