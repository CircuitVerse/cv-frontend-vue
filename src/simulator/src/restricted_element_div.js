/**
 * Update all restricted elements
 */
...
/**
 * Update restricted elements in a specific scope.
 * @param {Scope} scope
 */
...
export function showRestricted() {
  ...
  document.getElementById('restrictedDiv').innerHTML = 'The element has ' +
      'been restricted by mentor. Usage might lead to deduction in marks';
}
