<template>
  <messageBox v-model="promptStore.confirm.activate" :messageText="promptStore.confirm.messageText"
    :isPersistent="promptStore.confirm.isPersistent" :buttonList="promptStore.confirm.buttonList"
