  ...
  <div class="timing-diagram-panel draggable-panel">
    ...
    <div class="panel-body">
      <div class="timing-diagram-toolbar noSelect">
        <TimingDiagramButtons v-for="button in buttons" :key="button.title" :title="button.title" :icon="button.icon"
          :btn-class="button.class" class="timing-diagram-panel-button" :type="button.type" @click="() => {
...
import { ref } from 'vue'
import {plotArea as _plotArea} from '#/simulator/src/plot_area'
import { timingDiagramButtonActions } from '#/simulator/src/plot_area'
