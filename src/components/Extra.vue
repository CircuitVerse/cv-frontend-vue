  ...
  <div class="testbench-manual-panel draggable-panel noSelect defaultCursor">
    ...
    <div class="panel-body tb-test-not-null tb-panel-hidden">
      <div class="tb-manual-test-data">
        ...
        <button id="edit-test-btn" class="custom-btn--basic panel-button tb-dialog-button">
          Edit
        </button>
        <button id="remove-test-btn" class="custom-btn--tertiary panel-button tb-dialog-button">
          Remove
        </button>
      </div>
      <div style="overflow: auto; margin-bottom: 10px">
        <div class="tb-manual-test-buttons tb-group-buttons">
          ...
          <button id="prev-group-btn" class="custom-btn--basic panel-button tb-case-button-left tb-case-button">
            <i class="tb-case-arrow tb-case-arrow-left"></i>
          </button>
          <span class="tb-test-label group-label"></span>
          <button id="next-group-btn" class="custom-btn--basic panel-button tb-case-button-right tb-case-button">
        ...
        <div class="tb-manual-test-buttons tb-case-buttons">
          ...
          <button id="prev-case-btn" class="custom-btn--basic panel-button tb-case-button-left tb-case-button">
            <i class="tb-case-arrow tb-case-arrow-left"></i>
          </button>
          <span class="tb-test-label case-label"></span>
          <button id="next-case-btn" class="custom-btn--basic panel-button tb-case-button-right tb-case-button">
            <i class="tb-case-arrow tb-case-arrow-right"></i>
          </button>
        </div>
      </div>
      ...
      <div style="display: table; margin-top: 20px; margin-left: 8px">
        <div class="testbench-manual-panel-buttons">
          <button id="validate-btn" class="custom-btn--basic panel-button tb-dialog-button">
            Validate
          </button>
          <button id="runall-btn" class="custom-btn--primary panel-button tb-dialog-button">
            Run All
          </button>
        </div>
    ...
    <div class="panel-body tb-test-null">
      <div class="tb-manual-test-data">
        ...
        <button id="attach-test-btn" class="custom-btn--primary panel-button tb-dialog-button">
          Attach Test
        </button>
      </div>
    </div>
