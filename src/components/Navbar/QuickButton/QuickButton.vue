  ...
  <div class="quick-btn" id="quick-btn-id" @ondragover="dragover">
    ...
    <div>
      <button
        ...
        title="Download as Image (Ctrl + D)"
    ...
    <div>
      <button
        ...
        title="Fit to Screen (Alt + Shift + F)"
        @click="zoomToFit"
      ></button>
    </div>
    <div>
...
@media (max-width: 991px) {
  ...
  .quick-btn-delete {
    background: url(../../../styles/css/assets/shortcuts/delete.svg)
      center/cover;
    width: 25px;
    height: 19px;
    display: block;
