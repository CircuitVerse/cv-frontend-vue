<template>
    <InputGroups
        ...
        :property-name="$t('simulator.panel_body.element_properties.bit_width') + ':'"
    ...
    <InputGroups
        ...
        :property-name="$t('simulator.panel_body.element_properties.input_size') + ':'"
    ...
    <InputGroups
        ...
        :property-name="$t('simulator.panel_body.element_properties.delay') + ':'"
    ...
    <p v-if="!obj.disableLabel">
        <span>{{ $t('simulator.panel_body.element_properties.label') + ':' }}</span>
        <input
    ...
    <DropdownSelect
        ...
        :property-input-name="$t('simulator.panel_body.element_properties.direction') + ':'"
    ...
    <DropdownSelect
        ...
        property-name="newDirection"
        :property-value="obj.direction"
        :property-input-name="$t('simulator.panel_body.element_properties.orientation') + ':'"
