...
export default class NandGate extends CircuitElement implements ICircuitElement {
  private inp: Node[];
  inputSize: number;
...
NandGate.prototype.helplink = "https://docs.circuitverse.org/#/chapter4/4gates?id=nand-gate";
