...
export const shortcut = {
  ...
  isShortcutMatch: function (
    ...
    return this.checkKeysMatch(keys, character, e, options) && this.checkModifiersMatch(modifiers);
  },
  ...
  isModifierKey: function (key: string): boolean {
    return (
      key === "ctrl" || key === "control" || key === "shift" || key === "alt" || key === "meta"
    );
  },
